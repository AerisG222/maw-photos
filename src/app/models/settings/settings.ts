...
import { CategoryFilterSettings, DEFAULT_CATEGORY_FILTER_SETTINGS } from './category-filter-settings';
...
import { CategoryPageSettings, DEFAULT_CATEGORY_SETTINGS } from './category-page-settings';
...
import { DEFAULT_PHOTO_SETTINGS, PhotoPageSettings } from './photo-page-settings';
import { DEFAULT_RANDOM_SETTINGS, RandomPageSettings } from './random-page-settings';
import { DEFAULT_SEARCH_GRID_VIEW_SETTINGS, SearchGridViewSettings } from './search-grid-view-settings';
import { DEFAULT_SEARCH_LIST_VIEW_SETTINGS, SearchListViewSettings } from './search-list-view-settings';
